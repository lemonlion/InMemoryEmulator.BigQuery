...
namespace InMemoryEmulator.BigQuery.SqlEngine;
...
// IIF is not a BigQuery function (T-SQL). Use IF() instead.
...
or "APPROX_COSINE_DISTANCE" or "APPROX_EUCLIDEAN_DISTANCE"
...
var engine = _store.JsUdfEngine
	?? throw new NotSupportedException(
		"JavaScript UDFs require a JS engine. Install InMemoryEmulator.BigQuery.JsUdfs and call store.JsUdfEngine = new JintJsUdfEngine().");
