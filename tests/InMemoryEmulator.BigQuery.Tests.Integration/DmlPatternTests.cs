...
public class DmlPatternTests : IAsyncLifetime
{
	...
	[Fact] public async Task Insert_SingleRow()
	{
		...
		await Exec("INSERT INTO `{ds}.t1` (id, name) VALUES (1, 'Alice')");
	...
	[Fact] public async Task Insert_WithNull()
	{
		...
		await Exec("INSERT INTO `{ds}.t3` (id, name) VALUES (1, NULL)");
	...
	[Fact] public async Task Insert_WithExpr()
	{
		...
		await Exec("INSERT INTO `{ds}.t4src` (id, val) VALUES (1,10),(2,20)");
	...
	[Fact] public async Task Update_SingleColumn()
	{
		...
		await Exec("INSERT INTO `{ds}.u1` (id, name) VALUES (1,'old')");
	...
	[Fact] public async Task Update_MultipleColumns()
	{
		...
		await Exec("INSERT INTO `{ds}.u2` (id, name, val) VALUES (1,'a',10)");
	...
	[Fact] public async Task Update_AllRows()
	{
		...
		await Exec("INSERT INTO `{ds}.u3` (id, status) VALUES (1,'active'),(2,'active'),(3,'active')");
	...
	[Fact] public async Task Update_WithExpr()
	{
		...
		await Exec("INSERT INTO `{ds}.u4` (id, val) VALUES (1,10),(2,20),(3,30)");
	...
	[Fact] public async Task Update_NoMatch()
	{
		...
		await Exec("INSERT INTO `{ds}.u5` (id, name) VALUES (1,'a')");
	...
	[Fact] public async Task Update_SetNull()
	{
		...
		await Exec("INSERT INTO `{ds}.u6` (id, name) VALUES (1,'a')");
	...
	[Fact] public async Task Delete_SingleRow()
	{
		...
		await Exec("INSERT INTO `{ds}.d1` (id, name) VALUES (1,'a'),(2,'b'),(3,'c')");
	...
	[Fact] public async Task Delete_MultipleRows()
	{
		...
		await Exec("INSERT INTO `{ds}.d2` (id, name) VALUES (1,'a'),(2,'b'),(3,'c'),(4,'d')");
	...
	[Fact] public async Task Delete_AllRows()
	{
		...
		await Exec("INSERT INTO `{ds}.d3` (id, name) VALUES (1,'a'),(2,'b')");
	...
	[Fact] public async Task Delete_NoMatch()
	{
		...
		await Exec("INSERT INTO `{ds}.d4` (id, name) VALUES (1,'a')");
	...
	[Fact] public async Task Delete_WithExpr()
	{
		...
		await Exec("INSERT INTO `{ds}.d5` (id, val) VALUES (1,10),(2,20),(3,30),(4,40)");
	...
	[Fact] public async Task Merge_InsertOnly()
	{
		...
		await Exec("INSERT INTO `{ds}.m1` (id, name) VALUES (1,'a')");
		await Exec("CREATE TABLE `{ds}.m1s` (id INT64, name STRING)");
		await Exec("INSERT INTO `{ds}.m1s` (id, name) VALUES (2,'b'),(3,'c')");
	...
	[Fact] public async Task Merge_UpdateOnly()
	{
		...
		await Exec("INSERT INTO `{ds}.m2` (id, name) VALUES (1,'old'),(2,'old')");
		await Exec("CREATE TABLE `{ds}.m2s` (id INT64, name STRING)");
		await Exec("INSERT INTO `{ds}.m2s` (id, name) VALUES (1,'new1'),(2,'new2')");
	...
	[Fact] public async Task Merge_DeleteOnly()
	{
		...
		await Exec("INSERT INTO `{ds}.m3` (id, name) VALUES (1,'a'),(2,'b'),(3,'c')");
		await Exec("CREATE TABLE `{ds}.m3s` (id INT64, name STRING)");
		await Exec("INSERT INTO `{ds}.m3s` (id, name) VALUES (1,'a'),(2,'b')");
	...
	[Fact] public async Task Merge_Upsert()
	{
		...
		await Exec("INSERT INTO `{ds}.m4` (id, name) VALUES (1,'a')");
		await Exec("CREATE TABLE `{ds}.m4s` (id INT64, name STRING)");
		await Exec("INSERT INTO `{ds}.m4s` (id, name) VALUES (1,'updated'),(2,'new')");
	...
	[Fact] public async Task Insert_VerifyOrder()
	{
		...
		await Exec("INSERT INTO `{ds}.io1` (id, name) VALUES (3,'c'),(1,'a'),(2,'b')");
	...
	[Fact] public async Task Update_WithCase()
	{
		...
		await Exec("INSERT INTO `{ds}.uc1` (id, val, tier) VALUES (1,90,NULL),(2,50,NULL),(3,20,NULL)");
	...
	[Fact] public async Task Delete_WithSubquery()
	{
		...
		await Exec("INSERT INTO `{ds}.ds1` (id, name) VALUES (1,'a'),(2,'b'),(3,'c'),(4,'d')");
	...
	[Fact] public async Task Dml_Sequence()
	{
		...
		await Exec("INSERT INTO `{ds}.seq` (id, val) VALUES (1,10),(2,20),(3,30)");
		await Exec("UPDATE `{ds}.seq` SET val = val + 5 WHERE id = 1");
		await Exec("DELETE FROM `{ds}.seq` WHERE id = 3");
		await Exec("INSERT INTO `{ds}.seq` (id, val) VALUES (4,40)");
